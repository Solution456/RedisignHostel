...
<template>
  <svg class="sm:w-auo h-auto w-6" width="30" height="30" viewBox="0 0 100 100">
    ...
    <path class="ease-[cubic-bezier(0.4, 0, 0.2, 1)] transition-[stroke-dasharray,stroke-dashoffset] duration-[600ms]" fill="none" stroke="currentColor" stroke-width="6" stroke-linecap="round" stroke-dasharray="60 60" stroke-dashoffset="0" d="M 20,50 H 80"></path>
