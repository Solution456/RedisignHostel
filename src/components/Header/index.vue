...
<template>
  <div class="h-full flex justify-around items-center">
    <div class="user-info flex items-center gap-x-3 text-primary text-xl">
        <div class="avatar">
            <img class=" w-10 h-10 rounded-full object-cover object-center" src="https://i.pinimg.com/564x/04/38/f6/0438f6019adc4f0a1f8023ab5577fee4.jpg" alt="">
        </div>
